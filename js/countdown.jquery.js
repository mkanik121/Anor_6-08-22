(function ($) {
	...
	$.fn.countdown.getTimeRemaining = function (start, end, settings) {
		...
		// Built return object
		remaining.d = Math.floor(timeleft / (24 * 60 * 60 * 1000));
		remaining.h = Math.floor((timeleft / (24 * 60 * 60 * 1000) - remaining.d) * 24);
		remaining.m = Math.floor(((timeleft / (24 * 60 * 60 * 1000) - remaining.d) * 24 - remaining.h) * 60);
		remaining.s = Math.floor(timeleft / 1000 % 60);
		return remaining;
	};
}(jQuery));